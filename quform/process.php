 ...
 * $config['from'] = '%email%';
 */
$config['from'] = 'Tulla Contracting Corp';
 ...
 */
$config['autoreplyRecipient'] = '%name%';
...
$firstname = new Quform_Element('name', 'First Name');
$firstname->addFilter('trim');
$firstname->addValidator('required');
$form->addElement($firstname);

$email = new Quform_Element('email', 'Your Email');
...
$company = new Quform_Element('company', 'Phone Number');
...
$recaptcha->addValidator('recaptcha', array('secretKey' => '6Ld6Mp0eAAAAANMaaLi2d7Cp-gWZbPFT9aBCznls'));
